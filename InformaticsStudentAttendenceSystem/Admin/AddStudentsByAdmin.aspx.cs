...
{
    public partial class AddStudentsByAdmin : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into tblStudent values('" + txtStudentId.Text + "','" + txtStudentName.Text + "', '" + txtAdd.Text + "'," +
                ...
                "'" + txtEnrollDate.Text + "','" + drpCourseName.SelectedValue + "','" + drpModuleId.SelectedValue + "'," +
            ...
            Response.Redirect("~/Admin/ViewStudentsByAdmin.aspx");
        }

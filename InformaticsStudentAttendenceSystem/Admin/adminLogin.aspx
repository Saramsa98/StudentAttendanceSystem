<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminDashboard.aspx.cs" Inherits="InformaticsStudentAttendenceSystem.Admin.adminDashboard" %>
...
<body>
    ...
    <div id="alogin" class="auto-style2">
        <table class="auto-style3">
            ...
            <tr>
                <td class="atitle">
                   <asp:Image ID="Image2" runat="server" ImageUrl="~/assets/images/admin/login.png" Height="56px" Width="216px" /> </td>
            </tr>
            <tr>
                <td>
                    &nbsp;</td>

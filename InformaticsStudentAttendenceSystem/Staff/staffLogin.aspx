<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stafflogin.aspx.cs" Inherits="InformaticsStudentAttendenceSystem.Staff.staffLogin" %>
...
<head runat="server">
    ...
    <link href="~/Staff/stafflogin.css" rel="stylesheet" type="text/css" />
   <style type="text/css">
        .style1
        {
            width: 100px;
